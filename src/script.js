...
class BasicCharacterController {
  ...
  _LoadModels() {
    ...
    loader.setPath('./models/guy/glTF/');
    loader.load('ajidle.fbx', (fbx) => {
      ...
      loader.setPath('./models/guy/glTF/');
      loader.load('ajwalk.fbx', (a) => { _OnLoad('walk', a); });
      loader.load('ajidle.fbx', (a) => { _OnLoad('idle', a); });
      loader.load('ajback.fbx', (a) => {
        _OnLoad('back', a);
      });
    });
  }
